      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">isilah data di bawah ini</p>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="card z-index-0">
            <div class="card-body">
              <form action="" method="POST">
                ...
                <div class="mb-3">
                  <input type="password" name="password2" id="password2" class="form-control" placeholder="Konfirmasi Password" aria-label="Password">
                </div>
